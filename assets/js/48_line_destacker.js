...
am.createLineSeries(chartActualProduction, "PV - Deimpilatore Motori Rotazione Coppia", "time", "PV_Motori_Rotazione_PV_Coppia", "Canne/min", 1, false, true)
am.createLineSeries(chartActualProduction, "PV - Deimpilatore Motori Sollevamento Corrente", "time", "PV_Motori_Sollevamento_PV_Corrente", "", 1, false, true)
am.createLineSeries(chartActualProduction, "PV - Deimipilatore Motori Sollevamento Potenza", "time", "PV_Motori_Sollevamento_PV_Potenza", "kg", 1, false, true)
am.createLineSeries(chartActualProduction, "PV - Deimpilatore Motori Rotazione Velocità", "time", "PV_Motori_Rotazione_PV_Potenza", "sec", 1, false, true)
am.createLineSeries(chartActualProduction, "PV - Deimpilatore Motori Sollevamento Velocità", "time", "PV_Motori_Sollevamento_PV_Velocita", "kg", 1, false, true)
...
am.createLineSeries(chartHistoryProduction, "PV - Deimpilatore Motori Rotazione Coppia", "time", "PV_Motori_Rotazione_PV_Coppia", "Canne/min", 1, false, true)
am.createLineSeries(chartHistoryProduction, "PV - Deimpilatore Motori Sollevamento Corrente", "time", "PV_Motori_Sollevamento_PV_Corrente", "", 1, false, true)
am.createLineSeries(chartHistoryProduction, "PV - Deimipilatore Motori Sollevamento Potenza", "time", "PV_Motori_Sollevamento_PV_Potenza", "kg", 1, false, true)
am.createLineSeries(chartHistoryProduction, "PV - Deimpilatore Motori Rotazione Velocità", "time", "PV_Motori_Rotazione_PV_Potenza", "sec", 1, false, true)
am.createLineSeries(chartHistoryProduction, "PV - Deimpilatore Motori Sollevamento Velocità", "time", "PV_Motori_Sollevamento_PV_Velocita", "kg", 1, false, true)
...
query += 'mean("Robot_Deimpilatore_Motori_Rotazione_PV_Coppia") as "PV_Motori_Rotazione_PV_Coppia", '
query += 'mean("Robot_Deimpilatore_Motori_Sollevamento_PV_Corrente") as "PV_Motori_Sollevamento_PV_Corrente", '
query += 'mean("Robot_Deimpilatore_Motori_Sollevamento_PV_Potenza") as "PV_Motori_Sollevamento_PV_Potenza", '
query += 'mean("Robot_Deimpilatore_Motori_Rotazione_PV_Velocita") as "PV_Motori_Rotazione_PV_Velocita", '
query += 'mean("Robot_Deimpilatore_Motori_Sollevamento_PV_Velocita") as "PV_Motori_Sollevamento_PV_Velocita", '
query += 'mean("Robot_Deimpilatore_Motori_Rotazione_PV_Potenza") as "PV_Motori_Rotazione_PV_Potenza", '
